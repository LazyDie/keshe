...
<head>
    ...
    <link rel="stylesheet" href="//res.layui.com/layui/dist/css/layui.css?t=1512984638033" media="all">
    <style>
        body{margin: 10px;}
...
<script src="//res.layui.com/layui/dist/layui.js?t=1512984638033"></script>
<script>
    layui.config({
